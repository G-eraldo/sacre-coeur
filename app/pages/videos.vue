    ...
    <section class="pt-40 lg:pt-56 pb-20 bg-brand-warm min-h-screen">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <h2 class="text-4xl md:text-5xl font-bold text-brand-primary mb-6">Écoutez les voix de notre communauté
                </h2>
                <p class="text-gray-600 max-w-2xl mx-auto">Découvrez comment le Sacré-Cœur a touché la vie de nos
                    paroissiens. Des histoires authentiques de foi, de transformation et d'espérance.</p>
                <!-- Error state -->
                ...
                <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div v-for="video in videos" :key="video.id" class="bg-white rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            <h3 class="text-lg font-bold text-brand-primary mb-2">{{ video.title }}</h3>
