...
const enseignants = [
    { class: "TPS - PS", teacher: "Mme Othilie GAUDIN" },
    { class: "GS/CP", teacher: "Mr Ludovic HENRY" },
    { class: "CP/CE2", teacher: "Mr Pierre GORENFLOS" },
    { class: "CM1", teacher: "Mme Christelle DELARCHE" },
    { class: "CM2", teacher: "Mme Manon FRAZIER" },
]
