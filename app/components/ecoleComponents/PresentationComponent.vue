...
const presentation = {
    ...
    description: "L'Institution du Sacré-Cœur regroupe une école maternelle et une école élémentaire. Établissement privé catholique sous contrat d'État, nous sommes ouverts à tous, dans le respect des convictions de chacun et sans aucune discrimination sociale ou ethnique.",
    classes: [
        "3 classes de maternelle : TPS/PS - MS et GS",
        "5 classes de primaire : du CP au CM2",
        "1 classe Albatros : réseau d'aide"
    ],
    ...
    <section class="py-24 px-6 md:px-12 max-w-7xl mx-auto">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="space-y-8">
                ...
                <div class="pt-6 border-t border-[#f0ebe3]">
            ...
            <div class="relative">
                ...
                <NuxtImg src="https://res.cloudinary.com/dlnbsf2ed/image/upload/v1779258797/MS_htkcoz.png"
