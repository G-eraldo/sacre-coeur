            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="space-y-8">
                    ...
                    <div class="space-y-6 text-gray-700 leading-relaxed text-lg">
                        ...
                        <p>
                            Elle accueille des jeunes de la TPS à la 3ème et est placée sous
                            tutelle diocésaine.
                        </p>
                        <p>
                            Notre projet éducatif fonde ses propositions sur une vision chrétienne
                            de la personne humaine, dans un esprit familial à l’image du Christ pédagogue.
                        </p>
                    </div>
                </div>
                <div class="relative">
